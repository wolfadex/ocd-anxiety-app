...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{behaviorNameToAdd: '', safetyBehaviors: _List_Nil, showAddBehavior: false, showMenu: false},
...
var $author$project$Main$DismissAddBehaviorClicked = {$: 'DismissAddBehaviorClicked'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$Main$buttonSecondary, 'Cancel', $author$project$Main$DismissAddBehaviorClicked),
								A2($author$project$Main$buttonPrimary, 'Add', $author$project$Main$AddBehavior)
							]))
					]))
			]));
};
var $author$project$Main$ShowAddBehaviorClicked = {$: 'ShowAddBehaviorClicked'};
var $author$project$Main$ShowMenu = {$: 'ShowMenu'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'font-size', '10vw')
						]),
					_List_fromArray(
						[
							A2($author$project$Main$buttonPrimary, 'Start tracking', $author$project$Main$ShowAddBehaviorClicked)
						]))
				]));
	} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$Main$buttonPrimarySmall, 'Add behavior', $author$project$Main$ShowAddBehaviorClicked),
							A2($author$project$Main$buttonSecondaryIcon, '☰', $author$project$Main$ShowMenu)
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
...
var $author$project$Main$view = function (model) {
	return model.showAddBehavior ? $author$project$Main$viewAddBehavior(model) : (model.showMenu ? $author$project$Main$viewMenu(model) : $author$project$Main$viewBehaviorList(model));
};
